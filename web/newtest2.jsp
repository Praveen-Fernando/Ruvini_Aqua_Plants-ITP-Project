...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 ...
 <% 
    ...
    ResultSet rs;
            ...
            String query="SELECT * FROM `plantstock`where plantcode='"+id+"'";
...
try {
        if (request.getParameter("operation").equals("Update")) {
                ...
                String query="UPDATE `plantstock` SET `plantname`='"+nname+"',`quantity`='"+naddress+"',`price`='"
                        +ngrade+"',`date`='"+nclz+ "' WHERE `plantcode`='"+nid+"' ";
