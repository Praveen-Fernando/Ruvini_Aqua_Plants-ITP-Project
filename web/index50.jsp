...
$("#show-sidebar").click(function() {
 ...
 <div class="fixed-header">
        <div class="container">
            <nav>
            <a href="newDelivery">Add New Delivery Request</a>
            &nbsp;&nbsp;&nbsp;
            <a href="listdel">List All Delivery Request</a>
           </nav> 
        </div>
    </div>
      ...
      <h1>Delivery Management</h1>
           ...
           <div align="center" style="margin-right" >
          
        <c:if test ="${user != null}">
            
            <form action="updateDelivery" method="post" name="myform">
            ...
            <table border="1" cellpadding="5">
                ...
                <caption>
                    ...
                    <h2>
                        ...
                        <c:if test="${user !=null}">
                            <input type ="hidden" name='deliveryID' value="<c:out value='${user.deliveryID}'/>"/>
                        </c:if>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="OrderNumber" size="45"
                                     value="<c:out value='${user.orderNumber}'/>"
                                     />
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="ReceiverName" size="45"
                                     value="<c:out value='${user.receiverName}'/>"
                                     />
                                </td>
                             ...
                             <tr>
                                ...
                                <td>
                                    <input type="text" name="ReceiverAddress" size="45"
                                     value="<c:out value='${user.receiverAddress}'/>"
                                     />
                                </td>
                             ...
                             <tr>
                                ...
                                <td>
                                    <input type="text" maxlength="10" minlength="10" name="TelephoneNumber" size="45"
                             ...
                             <tr>
                                ...
                                <td>
                                    <input type="text" maxlength="5" name="PostalCode" size="45"
                            ...
                            <tr>
                                <td colspan="2" align='center'  >
                                    <button class="button button1" input type='submit' value="Save">Save</button>
