...
<body background="1.jpg">
   ...
   <div style="padding-left:290px;margin-top:20px;padding-right: 0px;">   
   <Input style="background-color:#4CAF50;color: white;" id="myInput" type="text" placeholder="Search..."> </Input>
   </div>
   <div style="padding-left:290px;margin-top:20px;padding-right: 0px;">   
<table id="t01">
  <tr>
