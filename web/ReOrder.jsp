...
<!--     <a href="new">Add New Supplier</a>
  ...
  <div class="row">
      ...
      <Input type="submit" value="print" onclick="window.print()"></Input>
  ...
  <div class="column middle">
      <div align="center"><br><br>
         <caption><h2>Re Order Items</h2></caption>
	   ...
	   String url,user,pass;
	      ...
	      try {
	            ...
	            con=DriverManager.getConnection(url,user,pass);
	                ...
	                String data="select * from reorder";
			...
			out.print("<td>"+rs.getString("requestdate")+"</td>");
			out.print("<td>"+rs.getString("requireddate")+"</td>");
...
<!--                <div align="center"><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
                 <Input style="background-color:#88aace;color:black;padding:5px 50px" id="myInput" type="text" placeholder="Search..."> </Input>     
                  <Input type="submit" value="print" onclick="window.print()"></Input>
  </div>-->
