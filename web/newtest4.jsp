<%-- 
    ...
    Created on : 04-May-2019, 23:08:53
    Author     : ino
--%>
...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 ...
 <% 
     String id="";
         String name="",address="",grade="",claz="";
            String url,duser,dpass;
          url="jdbc:mysql://localhost/ruvinidb";
       duser="root";
       dpass="";
     try {
             id=  request.getParameter("u").trim();
         } catch (Exception e) {
         }
    ...
    ResultSet rs;
            ...
            String query="SELECT * FROM `equipmentstock`where equipmentcode='"+id+"'";
...
claz=rs.getString(5);
            ...
            String nid=id,nname,naddress,nclz,ngrade,mess;
try {
        if (request.getParameter("operation").equals("Update")) {
                nname= request.getParameter("name1");
                ngrade= request.getParameter("grade1");
                nclz= request.getParameter("classN1");
                naddress= request.getParameter("address1");
                ...
                String query="UPDATE `equipmentstock` SET `equipmenttype`='"+nname+"',`quantity`='"+naddress+"',`price`='"
                        +ngrade+"',`date`='"+nclz+ "' WHERE `equipmentcode`='"+nid+"' ";
...
<!------ Include the above in your HEAD tag ---------->
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.1/css/font-awesome.min.css">
        ...
        <link type="text/css" rel="stylesheet" href="styleSheet/studentInfo.css">
...
$("#show-sidebar").click(function() {
  $(".page-wrapper").addClass("toggled");
    ...
    <body>
        ...
        <div class="studentInfo">
           <table border="1">
         <!--  <td><a href="StudentInfo.jsp" >Add Student</a></td>
 ...
 Equipment Code :               
<input type="hidden" name="id1" value="<%out.print(id);%>" readonly="readonly" >
<input type="text" name="id1" value="<%out.print(id); %>" readonly="readonly" > 
<br>
Equipment name:<br>
<input type="text" name="name1" value="<%out.print(name); %>" >
<br>
Quantity :<br>
<input type="number" name="address1" value="<%out.print(address); %>">
<br>
Price Rs:<br>
<input type="number" name="grade1" value="<%out.print(grade); %>">
<br>
Date:<br>
<input type="date" name="classN1" value="<%out.print(claz); %>">
<br><br>
                
                
<input style="background-color: #339900" onclick="myFunction()" type="Submit" name="operation" value="Update"/>             
         ...
         <!--   <table>   -->
            <!--    <tr>
                    <td>Plant Code :</td>
                    <td><input type="text" name="id1" value="<%out.print(id); %>" disabled=""/></td>
                </tr>
               
                <tr>
                    <td>Plant Name :</td>
                    <td><input type="text" name="name1" value="<%out.print(name); %>"/></td>
                </tr>
                <tr>
                    <td>Quantity :</td>
                    <td><input type="number name="address1" value="<%out.print(address); %>"/></td>
                </tr>
                <tr>
                    <td>Price : </td>
                    <td><input type="number" name="grade1" value="<%out.print(grade); %>"/></td>
                </tr>
                <tr>
                    <td>Date :</td>
                    <td><input type="text" name="classN1" value="<%out.print(claz); %>"/></td>
                </tr>
               <br/>
                <tr>
                    <td colspan="2">
