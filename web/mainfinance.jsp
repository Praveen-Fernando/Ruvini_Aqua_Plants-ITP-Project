...
<!------ Include the above in your HEAD tag ---------->
  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.6.1/css/font-awesome.min.css">
        ...
        <title>Administrator Finance Management Section</title>
  <style>
            .h1{
                color: Black;
...
<!--    <div class="body">-->
    <body class="body" >
        <div>
            <center>
            <h1 class="h1">Administrator Finance Management Section</h1>
            </center>
            <br><br><br><br>
     </div>
        
    <center>
        <form action="asset-list.jsp">
        <button class="button button2" type="submit">Assets Management Section</button>
        </form>
        <br><br><br>
        <form action="EquityLia-list.jsp">
        <button class="button button2" type="submit">Equity & Liabilities Management Section</button>
        </form >
        <br><br><br>
        
        <form action="BalanceSheet.jsp">
        <button class="button button2" type="submit">View Balancesheet</button>
        </form>
        <br> <br> <br> 
        
        <form action="Report.jsp" target="_blank">
        <button class="button button2" type="submit">Finance Report</button>
        </form>
    </center>
