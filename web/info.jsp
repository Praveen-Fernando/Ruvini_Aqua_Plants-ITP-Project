...
.chiller-theme .sidebar-footer>a:last-child {
    ...
    <body>
        <div id="customers" style="    margin-left: 400px; margin-top: 100px; font-size: 16px;">
    <center>
        <div style="    margin-bottom: 46px;"> <h1 style="font-size: 42px;">Delivery  Management</h1></div>
        ...
        <table border="1" cellpadding="5">
            ...
            <c:forEach var="user" items="${listUser}">
                ...
                <tr>
                    ...
                    <td><c:out value="${user.deliveryID}" /></td>
                    <td><c:out value="${user.orderNumber}" /></td>
                    <td><c:out value="${user.receiverName}" /></td>
                    <td><c:out value="${user.receiverAddress}" /></td>
                    ...
                    <td>
                        ...
                        <a href="editDelivery?deliveryID=<c:out value='${user.deliveryID}'/>">Edit</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="deleteDelivery?deliveryID=<c:out value='${user.deliveryID}'/>">Delete</a>
          ...
          <li class="sidebar-dropdown">
            ...
            <div class="sidebar-submenu">
              <ul>
                ...
                <li style="font-size: 13px;">
                  <a href="salReport.jsp">Main Report</a>
                </li>
              </ul>
            </div>
          </li>
