<%-- 
    ...
    Created on : Sep 29, 2019, 11:07:41 AM
    Author     : ASUS
--%>
    ...
    <body>
        ...
        <table border="2" id="myTable">
            ...
            <tr>
                ...
                <td>
                    <a href="https://mail.google.com/mail/u/0/#inbox?compose=DmwnWsTNGnCfkknSHtvjqrxbVgFstmDgxtxxbtDxjwzmjxhRQHrHNSgCzWLtMbMrFGpmdSvTMGvq"> <%=rs.getString("email")%></a>
                </td>
                <td>
