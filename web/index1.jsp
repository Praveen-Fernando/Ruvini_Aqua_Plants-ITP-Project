...
<center>
    <form class="form" method="post" name="resetform" action="insertplantdata">
      
      
       
        Plant Code :<input type="number" name="pid" placeholder="" max.length="5" >
		<br />
  
           Plant Name: <input type="text" name="pname" placeholder="****" required maxlength="30">
		<br />
               
		
            Quantity: <input type="number"  name="quant" placeholder="***" required maxlength="3">
		...
		Price Rs : <input type="number" name="price" placeholder="***" required>
		<br />

                  <br/>
                  Date : <input style="color:black;background-color:#ffffff;width: 100%;padding: 8px 15px;border-radius: 7px;align:center;" type="date" id="start" name="trip-start" value="" min="2018-01-01" max="">
                 <br/>
		<br/>
	        <br/>
