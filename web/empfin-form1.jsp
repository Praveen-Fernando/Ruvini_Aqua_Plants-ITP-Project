...
<html>
<head>
    <title>Employees Finance Update</title>
...
<!--      <input type="text" placeholder="Username" name="username" required="required">
 ...
 <center>
     <h1 style="font-size: 39px; font-weight: bold;">Employees finance Management</h1>
        <h2>
<!--         <a href="newC">Add New User</a>-->
         &nbsp;&nbsp;&nbsp;
         <a href="EmployeeSearch.jsp">List All Users</a>
...
<!--           <input type="hidden" name="empID" value="<c:out value='${empfin.empID}' />" required="required"/>
          ...
          <tr>
                <th>Employee ID </th>
                <td>
                 <input type="int" name="empID" size="45" value="<c:out value='${empfin.empID}' />"required="required"/>
                </td>
            </tr>
            <tr>
                <th>Job Type </th>
                <td>
                 <input type="text" name="jobType" size="45" value="<c:out value='${empfin.jobType}' />" required="required"  />
                </td>
            </tr>
            <tr>
                <th>Basic Salary </th>
                <td>
                 <input type="double" name="salary" id="bSal" size="45" value="<c:out value='${empfin.salary}' />" required="required"  />
                </td>
            </tr>
            <tr>
                <th>Tot OT </th>
                <td>
                 <input type="int" name="totalOtHours" id="ot" size="15" value="<c:out value='${empfin.totalOtHours}' />" required="required"/>
                </td>
            </tr>
                 <tr>
                <th>Tot Leaves </th>
                <td>
                 <input type="int" name="totalLeavs" size="15" value="<c:out value='${empfin.totalLeavs}' />" required="required"/>
                </td>
            </tr>
                 <tr>
                <th>Tot SLeaves</th>
            ...
            <div class="sidebar-submenu">
              <ul>
                ...
                <li style="font-size: 13px;">
                 ...
                 <li style="font-size: 13px;">
                  <a href="report_1.jsp" target="_blank">Report</a>
                </li>
              </ul>
            </div>
          </li>
