...
body{
  ...
  <script>
    ...
    var totalOtHours=document.myform.totalOtHours.value; 
    var totalLeavs=document.myform.totalLeavs.value; 
    var totalShortLeavs=document.myform.totalShortLeavs.value; 

    
    if(empID=="" || totalOtHours=="" || totalLeavs=="" || totalShortLeavs==""){
...
<body>
    <div style="    margin-top: 134px;    margin-left: 200px;">
 <center>
  <h1>Attendance</h1>
        <h2>
         <a href="newAttendence">Add Attendance</a>
         &nbsp;&nbsp;&nbsp;
         <a href="listAttendence">List All Attendance</a>
  ...
  <c:if test="${attend != null}">
   <form action="updateAttendence" method="post">
        ...
        <c:if test="${attend == null}">
   <form action="insertAttendence" method="post" name="myform">
        </c:if>
        <table id="customers">
          ...
          <c:if test="${attend != null}">
           <input type="hidden" name="attID" value="<c:out value='${attend.attID}' />" />
          </c:if>            
            <tr>
                <th> Employee ID: </th>
                <td>
                 <input type="Number" name="empID" size="45"
                   value="<c:out value='${attend.empID}' />"
                  />
                </td>
            </tr>
            <tr>
                ...
                <td>
                 <input type="Number" name="totalOtHours" size="45"
                   value="<c:out value='${attend.totalOtHours}' />"
                 />
                </td>
            </tr>
             <tr>
                <th>Total Leaves : </th>
                <td>
                 <input type="Number" name="totalLeavs" size="45"
                   value="<c:out value='${attend.totalLeavs}' />"
                 />
                </td>
            </tr>
             <tr>
                ...
                <td>
                 <input type="Number" name="totalShortLeavs" size="45"
                   value="<c:out value='${attend.totalShortLeavs}' />"
                 />
                </td>
            </tr>
            <tr>
