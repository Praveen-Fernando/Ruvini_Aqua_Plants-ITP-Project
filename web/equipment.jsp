...
<center>
  <form method="post" name="resetform" action="insertequipmentdata">
		...
		<br />
            ...
            Quantity: <input type="number" name="quant" placeholder="***" required>
                <br/>
		...
		<br />
               ...
               <br/>
               Date : <input style="color:black;background-color:#ffffff;width: 100%;padding: 8px 15px;border-radius: 7px;align:center;" type="date" id="start" name="trip-start"
       value=""
       min="2018-01-01" max="">
                 <br/>
		<br/>
