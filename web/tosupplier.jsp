...
String plantcode = request.getParameter("u");
...
String sql ="select * from plantstock where plantcode="+plantcode;
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>

<h1 align="center">Available Plants</h1>
<div style="padding-left:300px;margin-top:30px;">
<center>
<form class="form1" method="post" action="reorderservlet">
  <input type="hidden" name="plantcode" value="<%=resultSet.getString("plantcode") %>" readonly="readonly" >  
 Item Code :<input type="text" name="plantcode" value="<%=resultSet.getString("plantcode") %>" readonly="readonly" > 
<br>
 Item Name:<br>
<input type="text" name="plantname" value="<%=resultSet.getString("plantname") %>" readonly="readonly" >
<br>
