...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 ...
 <% 
    ...
    ResultSet rs;
            ...
            String query="SELECT * FROM `chemicalstock`where chemicalcode='"+id+"'";
...
try {
        if (request.getParameter("operation").equals("Update")) {
                ...
                String query="UPDATE `chemicalstock` SET `chemicaltype`='"+nname+"',`weight`='"+naddress+"',`price`='"
                        +ngrade+"',`date`='"+nclz+ "' WHERE `chemicalcode`='"+nid+"' ";
