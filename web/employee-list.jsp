<%-- 
    ...
    Created on : Aug 22, 2019, 5:18:44 PM
    Author     : sudana
--%>
  ...
  <h1>Employee Handling</h1>
    ...
    <div align="center">
        ...
        <table id="myTable" >
            ...
            <c:forEach var="empDAO" items="${listemployee}">
                <tr>
                    <td><c:out value="${empDAO.id}" /></td>
                    <td><c:out value="${empDAO.NIC}" /></td>
                    <td><c:out value="${empDAO.name}" /></td>
                     <td><c:out value="${empDAO.birthday}" /></td>
                    <td><c:out value="${empDAO.gender}" /></td>
                    <td><c:out value="${empDAO.email}" /></td>
                     <td><c:out value="${empDAO.phone}" /></td>
                    <td><c:out value="${empDAO.salary}" /></td>
                    <td><c:out value="${empDAO.jobType}" /></td>
                    <td><c:out value="${empDAO.registerDate}" /></td>
                    <td>
                     <a href="editEmployee?id=<c:out value='${empDAO.id}' />">Edit</a>
                     &nbsp;&nbsp;&nbsp;&nbsp;
                     <a href="deleteEmployee?id=<c:out value='${empDAO.id}' />">Delete</a>                     
                    </td>
                </tr>
            </c:forEach>
