...
<html>
<head>
 <title>Employee Finance List</title>
...
<!--      <input type="text" placeholder="Username" name="username" required="required">
    ...
    <div style="margin-left: 244px; margin-top: 85px;">
 <center>
  <h1 style="font-size: 39px; font-weight: bold;">Employee Finance List</h1>
        <h2>
       <a href="EmployeeSearch.jsp">Calculate New Salary</a>
         &nbsp;&nbsp;&nbsp;
         <a href="listEmpFin">List All Users</a>
...
<!--            <caption><h2>List of Users</h2></caption>-->
            ...
            <c:forEach var="empfin" items="${listEmpFin}">
                
                <tr>
                    <td><c:out value="${empfin.empID}" /></td>
                    <td><c:out value="${empfin.jobType}" /></td>
                    <td><c:out value="${empfin.salary}" /></td>
                    <td><c:out value="${empfin.totalOtHours}" /></td>
                    <td><c:out value="${empfin.bonus}" /></td>
                    <td><c:out value="${empfin.gSal}" /></td>
                    <td><c:out value="${empfin.netSal}" /></td>
                    <td>
                        <div>
                            
                            <a href="editC?empID=<c:out value='${empfin.empID}' />">Update</a></div>
                     &nbsp;&nbsp;&nbsp;&nbsp;
                     <div>
                         <a onclick="if (confirm('⚠warning ⚠ \n\Are you sure you want to delete?')) form.action='/Config?pg=FIBiller&amp;cmd=delete'; else return false;" href="deleteC?empID=<c:out value='${empfin.empID}'  />">Delete</a>  </div>                   
                    </td>
                </tr>
            </c:forEach>
        </table>
