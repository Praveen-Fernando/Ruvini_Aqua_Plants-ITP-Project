...
.chiller-theme .sidebar-footer>a:last-child {
 ...
 <form method="post" name="resetform" action="index1.jsp">
     ...
     <form method="post" name="resetform" action="viewreorderedItems.jsp">	
				
				
                <input type="submit" name="name" value="View Re-Order Items ">
				
				
				</form>
			
  <form method="post" name="resetform" action="plantreport.jsp">	
		

                <input type="submit" name="name" value="Report Generate " action="plant.html">
...
<!--                 <center>    
              <img src="download.png" alt="Admin" />    
                </center>-->
