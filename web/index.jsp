<%-- 
    Document   : login
    Created on : Sep 29, 2019, 5:01:17 PM
    Author     : maduranga
--%>
...
.ab-b-r {
	...
	bottom: 0px;
        ...
        <script>
            function validate(){
                var username=document.log.username.value;
                var pasword=document.log.pass.value;
    ...
    <body>
		...
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
				<form name="log" class="login100-form validate-form flex-sb flex-w" action="loginserv">
...
<!--							<a href="#" class="txt1">
					...
					<div class="container-login100-form-btn m-t-17">
						<button onClick="return validate()" class="login100-form-btn">
							Login
						</button>
					</div>
