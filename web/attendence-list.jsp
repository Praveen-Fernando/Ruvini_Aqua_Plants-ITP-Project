...
<body>
<div style="margin-top: 179px;margin-left: 405px;
    margin-right: 73px;">
 <center>
  <h1>Employee Attendance</h1>
    ...
    <div align="center">
        ...
        <table id="myTable">
            ...
            <c:forEach var="attend" items="${listAttendence}">
                <tr>
                    <td><c:out value="${attend.attID}" /></td>
                    <td><c:out value="${attend.empID}" /></td>
                    <td><c:out value="${attend.totalOtHours}" /></td>
                    <td><c:out value="${attend.totalLeavs}" /></td>
                    <td><c:out value="${attend.totalShortLeavs}" /></td>
                     <td><c:out value="${attend.totalAttendence}" /></td> 
                    <td>
                     <a href="editAttendence?attID=<c:out value='${attend.attID}' />">Edit</a>
                     &nbsp;&nbsp;&nbsp;&nbsp;
                     <a href="deleteAttendence?attID=<c:out value='${attend.attID}' />">Delete</a>                     
                    </td>
                </tr>
            </c:forEach>
        </table>
<!--        <a href="report.jsp" target="_blank">report</a>-->
        <script>
function myFunction() {
