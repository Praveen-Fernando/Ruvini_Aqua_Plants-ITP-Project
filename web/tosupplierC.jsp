...
String chemicalcode = request.getParameter("u");
...
String sql ="select * from chemicalstock where chemicalcode="+chemicalcode;
resultSet = statement.executeQuery(sql);
while(resultSet.next()){
%>

<h1 align="center">Available chemicals</h1>
<div style="padding-left:300px;margin-top:30px;">
<center>
<form class="form1" method="post" action="reorderservletC">
   <input type="hidden" name="plantcode" value="<%=resultSet.getString("chemicalcode") %>" readonly="readonly" >
 Item Code :<input type="text" name="plantcode" value="<%=resultSet.getString("chemicalcode") %>" readonly="readonly" > 
<br>
Item name:<br>
<input type="text" name="plantname" value="<%=resultSet.getString("chemicaltype") %>" readonly="readonly" >
<br>
Required Quantity :<br>
<input type="number" name="quantity" required value="<%=resultSet.getString("weight") %>">
<br>
Request date:<br><br>
