...
body{
 ...
 <script>
    ...
    var Name=document.myform.value; 
    ...
    var registerDate=document.myform.registerDate.value; 
    
    if(NIC=="" || Name=="" || birthday=="" || gender=="" || email=="" || phone=="" || salary=="" || jobType=="" || registerDate==""){
 ...
 if (!(/^\+?([0-9]{2})\)?[-. ]?([0-9]{4})[-. ]?([0-9]{4})$/.test(myform.phone.value))){
...
<body>
 <div style="    margin-top: 90px;    margin-left: 266px;">
 <center>
  <h1>Employee Handling</h1>
        <h2>
         <a href="newEmployee">Add New Employee</a>
         &nbsp;&nbsp;&nbsp;
         <a href="listeeeee">List All Employee</a>
         
        </h2>
 </center>
    <div align="center">
  <c:if test="${empDAO != null}">
   <form action="updateEmployee" method="post">
        </c:if>
        <c:if test="${empDAO == null}">
   <form action="insertEmployee" method="post" name="myform">
        </c:if>
        <table id="customers">
          ...
          <c:if test="${empDAO != null}">
           <input type="hidden" name="id" value="<c:out value='${empDAO.id}' />" />
          </c:if>            
            <tr>
                <th> NIC: </th>
                <td>
                 <input type="text" name="NIC" size="45"
                   value="<c:out value='${empDAO.NIC}' />"
                  />
                </td>
            </tr>
            <tr>
             ...
             <tr>
                ...
                <td>
                   ...
                   value="<c:out value='${empDAO.birthday}' />"
                  />
                </td>
            </tr>
            <tr>
                <th> Gender: </th>
                <td>
                    <select class="input100" type="text" name="gender" placeholder="gender" value="<c:out value='${empDAO.gender}' />">
            ...
            <tr>
                ...
                <td>
                 <input type="text" name="email" size="45"
                   value="<c:out value='${empDAO.email}' />"
                  />
                </td>
            </tr>
            <tr>
                ...
                <td>
                 <input type="text" name="phone" size="45"
                   value="<c:out value='${empDAO.phone}' />"
                  />
                </td>
            </tr>
            <tr>
                ...
                <td>
                   ...
                   value="<c:out value='${empDAO.salary}' />"
                  />
                </td>
            </tr>
            <tr>
                <th> Job type: </th>
                <td>
                    <select class="input100" type="text" name="jobType" placeholder="jobtype"  value="<c:out value='${empDAO.jobType}' />">
                        <option disabled="" selected="" value=""></option>
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="date" name="registerDate" size="45"
                   value="<c:out value='${empDAO.registerDate}' />"
                  />
                </td>
            </tr>
            <tr>
             <td colspan="2" align="center">
                 <input type="submit" class="button" value="Save" onclick="return validate()" />
             </td>
            </tr>
