...
.full{
 ...
 <script type="text/javascript">
     function validate(){
         var assetname=document.insertform.Name.value;
         var valueq=document.insertform.Value.value;
         if(assetname=="" || valueq==""){
...
<div class="full">
 <center>
  ...
  <h1>Asset Management</h1>
         ...
         <a href="newasset">Add New Asset</a>
         &nbsp;&nbsp;&nbsp;
         <a href="list">List All Asset</a>
         
        
 </center>
    <div align="center">
  <c:if test="${asset != null}">
   <form name="updateform" action="updateasset" method="post">
        </c:if>
        <c:if test="${asset == null}">
   <form name="insertform" action="insertasset" method="post">
          ...
          <c:if test="${asset != null}">
           <input type="hidden" name="NO" value="<c:out value='${asset.NO}' />" />
          </c:if>            
            <div class="container-contact100">
            <div class="wrap-contact100">
                
                <div>
                    <span class="contact100-form-title">Name of the assert:</span> 
                
                 <select class="input100" type="text" name="Name" placeholder="Asset name" value="<c:out value='${asset.name}' />" >
                     ...
                     <option value="Deferred Income Tax">Deferred Income Tax</option> 
             ...
             <div>
                 ...
                 <input  class="input100" type="Number" name="Value" placeholder="Value"
                   value="<c:out value='${asset.value}' />"
                 />
