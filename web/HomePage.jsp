<%-- 
    Document   : HomePage
    Created on : Sep 21, 2019, 10:59:05 PM
    Author     : ACER
--%>
...
@media screen and (max-width: 600px) {
  ...
  .topnav input[type=text] {
    ...
    <body <img src="im3.jpg">>
        
<div class="topnav">
  <div class="login-container">
      <form action="/action_page.php" style="padding-top: 5px; padding-bottom: 12px; padding-top: 52px; ">
...
<!--      <button type="submit" >Login</button>-->
        ...
        <div class="home" style="padding-top: 99px; margin-left: 314px;" >
	...
	<div class="col-md-3 col-sm-4">
      <div class="wrimagecard wrimagecard-topimage">
         ...
         <div class="wrimagecard-topimage_header" style="background-color: rgba(130, 93, 9, 0.1)">
          ...
          <div class="wrimagecard-topimage_title">
            <h4>Employee Finance Management
